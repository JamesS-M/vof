...
csvtojson()
  ...
  .on('json', (jsonObj, rowIndex) => {
    ...
    let knownKeywords = ['Englische Oper (Gattung)', 'Französische Oper (Gattung)', 'Italienische Oper (Gattung)', 'Oper (Gattung)', 'Oper (Veranstaltung)', 'Oper, Libretto', 'Oper, Stoffe', 'Opera buffa', 'Opéra comique (Gattung)', 'Opera seria', 'Operette', 'Opernhäuser/haus', 'Opernpraxis', 'Opernsänger/innen', 'Publikum, Oper', 'Querelle des Bouffons', 'Querelle des Gluckistes et des Piccinistes', 'Querelle des Italiens...', 'Singspiel', 'Theatertruppen', 'Tragédie lyrique', 'Vergleich Oper/Drama']
